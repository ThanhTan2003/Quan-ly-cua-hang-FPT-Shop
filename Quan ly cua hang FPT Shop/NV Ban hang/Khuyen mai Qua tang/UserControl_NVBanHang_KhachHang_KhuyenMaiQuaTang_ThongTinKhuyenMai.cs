...
{
    public partial class UserControl_NVBanHang_KhachHang_KhuyenMaiQuaTang_ThongTinKhuyenMai : UserControl
    {
        public UserControl_NVBanHang_KhachHang_KhuyenMaiQuaTang_ThongTinKhuyenMai()
        {
            InitializeComponent();
        }
